...
export default class App {
    ...
    private connectToTheDatabase() {
        ...
        // Connect to localhost:27017, create "ingatlanNeve" database if not exist:
        mongoose.connect("mongodb://127.0.0.1:27017/ingatlanNeve").catch(() => console.log("Unable to connect to the server. Please start MongoDB."));
